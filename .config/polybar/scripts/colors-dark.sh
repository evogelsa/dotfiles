...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = ${xrdb:color1:#111111}/g' $PDIR/colors.ini
sed -i -e 's/shade2 = .*/shade2 = ${xrdb:color2:#222222}/g' $PDIR/colors.ini
sed -i -e 's/shade3 = .*/shade3 = ${xrdb:color3:#333333}/g' $PDIR/colors.ini
sed -i -e 's/shade4 = .*/shade4 = ${xrdb:color4:#444444}/g' $PDIR/colors.ini
sed -i -e 's/shade5 = .*/shade5 = ${xrdb:color5:#555555}/g' $PDIR/colors.ini
sed -i -e 's/shade6 = .*/shade6 = ${xrdb:color6:#666666}/g' $PDIR/colors.ini
sed -i -e 's/shade7 = .*/shade7 = ${xrdb:color7:#777777}/g' $PDIR/colors.ini
sed -i -e 's/shade8 = .*/shade8 = ${xrdb:color8:#888888}/g' $PDIR/colors.ini
sed -i -e 's/accent = .*/accent = ${xrdb:color9:#999999}/g' $PDIR/colors.ini
sed -i -e 's/bground = .*/bground = ${xrdb:background:#000000}/g' $PDIR/colors.ini
sed -i -e 's/modulefg-alt = .*/modulefg-alt = ${xrdb:color7:#aaaaaa}/g' $PDIR/colors.ini
# Restarting polybar
$LAUNCH &
